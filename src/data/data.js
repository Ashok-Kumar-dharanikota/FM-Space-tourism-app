  ...
  "destinations": [
    {
      "name": "Moon",
      "images": {
        "png": require("./../assets/planets/image-moon.png"),
    ...
    },
    {
      "name": "Mars",
      "images": {
        "png": require("../assets/planets/image-mars.png"),
    ...
    },
    {
      "name": "Europa",
      "images": {
        "png": require("../assets/planets/image-europa.png"),
    ...
    },
    {
      "name": "Titan",
      "images": {
        "png": require("../assets/planets/image-titan.png"),
  ...
  "technology": [
    {
      ...
      "images": {
        ...
        "landscape": require("./../assets/technology/image-launch-vehicle-portrait.jpg")
      },
